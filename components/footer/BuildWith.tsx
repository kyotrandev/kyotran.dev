...
const BuildWith = () => (
  <div className="flex items-center space-x-1">
    ...
    <div className="flex space-x-1.5">
      <Link href="https://nextjs.org?ref=kyotran.dev">
        <BrandIcon type="NextJS" className="h-5 w-5" />
      </Link>
      <Link href="https://tailwindcss.com?ref=kyotran.dev">
        <BrandIcon type="TailwindCSS" className="h-5 w-5" />
      </Link>
      <Link href="https://www.typescriptlang.org?ref=kyotran.dev">
        <BrandIcon type="Typescript" className="h-5 w-5" />
      </Link>
      <Link href="https://umami.is?ref=kyotran.dev" className="pl-px">
